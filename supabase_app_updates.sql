...
alter table public.app_updates add column if not exists installer_sha256 text;
...
--
-- insert into public.app_updates (platform, version, installer_url, installer_sha256, notes)
-- values (
--   'windows',
--   '1.0.3',
